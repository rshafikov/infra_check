...
# Примечание. Принцип работы проверок
	...
	1.При запуске скрипта выходит диалог, который предлает версию устанавливаемой ОС Астра
	Необходимо с клавиатуры вести цифру  1 -  Астра 1.6 или 2 - Астра 1.7.
	При нажати другой клавиши скрипт завершит работу и попросит ввести правильные версии.
